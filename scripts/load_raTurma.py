...
def run():
    texto_completo = ''
    with open(r"C:\Users\Jihad\Desktop\projetos\dados\ajuste_2024_3_matriculas_deferidas.pdf", 'rb') as f:
        pdf = PdfReader(f)
        for pagina in pdf.pages:
            texto_completo += pagina.extract_text()
    
    # Extrair as informações das colunas de interesse
    texto_completo = texto_completo.split('11202130292')[1:] #caso pare em algum ra, comentar as duas linhas abaixo
